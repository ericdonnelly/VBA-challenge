...
For Each ws In Worksheets
  ' Create headers
    ...
    ws.Cells(2, 8).Value = "greatest_percent_increase"
    ws.Cells(3, 8).Value = "greatest_percent_decrease"
    ws.Cells(4, 8).Value = "greatest_total_volume"
  ...
  'Set an initial variable for holding the greatest percent increase
  Dim GPercent_Increase As String
  'Set an initial variable for holding the greatest percent decrease
  Dim GPercent_Decrease As String
  'Set an initial variable for holding the greatest total volume
  Dim GTotal_Volume As String
